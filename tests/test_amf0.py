...
class EncoderTestCase(ClassCacheClearingTestCase, EncoderMixIn):
    ...
    def test_undefined(self):
        self.assertEncoded(miniamf.Undefined, '\x06')
    ...
    def test_typed_object(self):
        ...
        self.assertEncoded(
            x,
            '\x10\x00\x0eorg.miniamf.spam\x00\x03baz\x02\x00\x05hello\x00\x00\t'
        )
...
class DecoderTestCase(ClassCacheClearingTestCase, DecoderMixIn):
    ...
    def test_undefined(self):
        self.assertDecoded(miniamf.Undefined, '\x06')
    ...
    def test_bad_reference(self):
        self.assertRaises(miniamf.ReferenceError, self.decode, '\x07\x00\x03')
    ...
    def test_bad_type(self):
        self.assertRaises(miniamf.DecodeError, self.decode, '\xff')
...
class AMF0ContextTestCase(unittest.TestCase):
    ...
    def test_decode(self):
        from miniamf.remoting import decode
