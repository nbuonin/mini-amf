...
PyAMF allows you to register aliases for remote Python classes that
...
PyAMF supplies class decorators_ that help you to avoid writing most
of the boilerplate code that is used when registering classes in
Python. An example:
