...
#: out into L{AMF3<miniamf.amf3>} mode. In this case the next byte will be the
...
class Decoder(codec.Decoder):
    ...
    def readUndefined(self):
        ...
        @return: L{Undefined<miniamf.Undefined>}
        """
    ...
    def readObject(self):
        ...
        @rtype: L{ASObject<miniamf.ASObject>}
        """
        obj = miniamf.ASObject()
        self.context.addObject(obj)
...
class Encoder(codec.Encoder):
    ...
    def writeAMF3(self, data):
        """
        Writes an element in L{AMF3<miniamf.amf3>} format.
        """
